...
class RidgeRegression(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, l2_reg=1, step_size=.005,  max_num_epochs = 5000):
        ...
        self.unreg_objective = nodes.SquaredL2DistanceNode(a=self.prediction, b=self.y,
                                               node_name="square loss")
        
        self.reg_loss = nodes.L2NormPenaltyNode(l2_reg=self.l2_reg, w=self.w, 
                                                node_name="regularization loss")
        
        self.objective = nodes.SumNode(a=self.unreg_objective, b=self.reg_loss, node_name="regularized square loss")
